...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="Plan1.Azure" generation="1" functional="0" release="0" Id="e78611c6-2274-4ac6-8192-ad30e1a6df81" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="Plan1.AzureGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="Plan1" generation="1" functional="0" release="0" software="D:\EnterpriseRepo\CS-M\Plan1\Plan1.Azure\csx\Debug\roles\Plan1" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="1792" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="ec0aeb37-3e14-448e-b953-c5185c6aac65" ref="Microsoft.RedDog.Contract\ServiceContract\Plan1.AzureContract@ServiceDefinition.build">
      <interfacereferences>
        <interfaceReference Id="202813c4-ef63-498e-80e7-94afcbd93fee" ref="Microsoft.RedDog.Contract\Interface\Plan1:Endpoint1@ServiceDefinition.build">
          <inPort>
            <inPortMoniker name="/Plan1.Azure/Plan1.AzureGroup/Plan1:Endpoint1" />
          </inPort>
        </interfaceReference>
