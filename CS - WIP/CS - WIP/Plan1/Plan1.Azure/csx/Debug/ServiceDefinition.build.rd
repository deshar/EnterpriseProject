...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="Plan1.Azure" generation="1" functional="0" release="0" Id="62114731-435f-4b14-8c7c-89546b1fa5bf" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="Plan1.AzureGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="Plan1" generation="1" functional="0" release="0" software="D:\EnterpriseRepo\CS - WIP\CS - WIP\Plan1\Plan1.Azure\csx\Debug\roles\Plan1" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="1792" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="d9712c43-0408-4d4d-aef8-1d1e01bf3965" ref="Microsoft.RedDog.Contract\ServiceContract\Plan1.AzureContract@ServiceDefinition.build">
      <interfacereferences>
        <interfaceReference Id="918b1fd6-4efb-48ba-9568-b4e82e92438f" ref="Microsoft.RedDog.Contract\Interface\Plan1:Endpoint1@ServiceDefinition.build">
          <inPort>
            <inPortMoniker name="/Plan1.Azure/Plan1.AzureGroup/Plan1:Endpoint1" />
          </inPort>
        </interfaceReference>
